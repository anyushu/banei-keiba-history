    ...
    <div className="section bg-[url('/images/bg_3_sp.png')] md:bg-[url('/images/bg_3.png')]">
      ...
      >
        ...
        <div className="flex h-full flex-col items-center md:flex-row md:px-11">
          <Image
            src="/images/famous_horses_1.png"
            className="mt-auto shrink md:mt-0"
            width={640}
            height={480}
            alt="名馬"
          />
          <div className="mt-5 mb-auto max-w-md md:my-0 md:ml-12">
            <h3 className="mb-3 text-lg md:text-2xl">イレネー</h3>
            <p className="my-3 text-xs md:text-sm">年代：1908年～1928年</p>
      ...
      >
        ...
        <div className="flex h-full flex-col items-center md:flex-row md:px-11">
          ...
          <div className="mt-5 mb-auto max-w-md md:my-0 md:ml-12">
            ...
            <p className="my-3 text-xs md:text-sm">現役期間：2004年～2013年</p>
            <p className="text-sm md:text-base">
      ...
      >
        ...
        <div className="flex h-full flex-col items-center md:flex-row md:px-11">
          ...
          <div className="mt-5 mb-auto max-w-md md:my-0 md:ml-12">
            ...
            <p className="my-3 text-xs md:text-sm">現役期間：1979年～1986年</p>
            <p className="text-sm md:text-base">
      ...
      >
        ...
        <div className="flex h-full flex-col items-center md:flex-row md:px-11">
          ...
          <div className="mt-5 mb-auto max-w-md md:my-0 md:ml-12">
            ...
            <p className="my-3 text-xs md:text-sm">現役期間：1998年～2007年</p>
            <p className="text-sm md:text-base">
      ...
      >
        ...
        <div className="flex h-full flex-col items-center md:flex-row md:px-11">
          ...
          <div className="mt-5 mb-auto max-w-md md:my-0 md:ml-12">
            ...
            <p className="my-3 text-xs md:text-sm">現役期間：2013年～2021年</p>
            <p className="text-sm md:text-base">
      ...
      >
        ...
        <div className="flex h-full flex-col items-center md:flex-row md:px-11">
          ...
          <div className="mt-5 mb-auto max-w-md md:my-0 md:ml-12">
            ...
            <p className="my-3 text-xs md:text-sm">現役期間：1988年～1995年</p>
            <p className="text-sm md:text-base">
