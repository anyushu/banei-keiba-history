    ...
    >
      <div className="container relative mx-auto py-4">
        <h2 className="relative text-center lg:pt-[3dvh]">
          ...
          <Image
            className="absolute top-1/2 left-1/2 w-[90px] max-w-[200px] translate-y-[calc(-50%-25px)] translate-x-[calc(-50%-90px)] lg:w-auto lg:translate-y-0 lg:translate-x-[calc(-50%-18rem)]"
